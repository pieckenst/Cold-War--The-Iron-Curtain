...
NDiplomacy = {
	...
	TENSION_DECAY = 0.00,							-- Each months tension decays this much
	TENSION_SIZE_FACTOR = 0.25,						-- All action tension values are multiplied by this value
	TENSION_TIME_SCALE_START_DATE = "1940.1.1.12",	-- Starting at this date, the tension values will be scaled down (will be equal to 1 before that)
	...
	TENSION_TIME_SCALE_MIN = 45.0,					-- Timed tension scale won't decrease under this value
	TENSION_GUARANTEE = 0,
...
NAI = {
	...
	DIPLOMACY_FACTION_GLOBAL_TENSION_FACTOR = 1.0,-- How much the AI takes global tension into account when considering faction actions
