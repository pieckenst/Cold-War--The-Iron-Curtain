...
NDiplomacy = {
	...
	VOLUNTEERS_PER_TARGET_PROVINCE = 1.0,			-- Each province owned by the target country contributes this amount of volunteers to the limit.
	...
	TENSION_CIVIL_WAR_IMPACT = 0.5,					-- civil war multiplier on tension.
	...
	TENSION_PUPPET = 5,								-- Amount of tension generated by puppeting (per state)
...
NAI = {
	...
	DIPLOMACY_LEAVE_FACTION_OPINION_FACTOR = 10.0,-- How much the opinion of countries being targeted by faction leader matters when deciding to leave a faction (democratic only)
