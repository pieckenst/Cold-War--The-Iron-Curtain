...
NDiplomacy = {
	...
	BASE_PEACE_TAKE_UNCONTROLLED_STATE_FACTOR = 125, -- Base factor for taking state you do not control
...
NAir = {
	...
	COMBAT_SITUATION_WIN_CHANCE_FROM_STATS = 0.1, 		-- How much good stats difference (speed+agility) affects the winning chance (situation win = give a hit, not necessary kill).
...
NAI = {
	...
	PLAN_FRONTUNIT_DISTANCE_FACTOR = 1.2,		-- Factor for candidate units distance to front positions.
